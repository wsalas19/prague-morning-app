...
const DetailsContainer = ({data}:any) => {
  ...
  return (
    <>
    {isClient && <section className={styles["job-details-page"]}>
          ...
          <section className={styles["job-details-page-info"]}>
            ...
            <div className={styles["job-general-details"]}>
              <div>
                ...
                <a target="_blank" href={data?.jobUrl}
                   className={styles["job-general-job-url"]}>{data?.jobUrl}</a>
              </div>
              <div className={styles["job-general-buttons"]}>
                <Button style={{width: "145px"}} className={`btn-grey-outlined`}>
                  Report Job
                </Button>
                <Button style={{width: "145px"}} className={`btn-secondary-search`}
            ...
            {data?.advertisedDate && <div className={styles["job-date-info"]}>
            ...
            <div className={styles["job-description"]}>
              ...
              <p dangerouslySetInnerHTML={{__html: data?.description}} className={styles["job-description-content"]}/>
            </div>
            <Divider/>
            <div className={styles["job-check-details"]}>
              <p>Please check the information above before applying for a job <span>*</span></p>
            </div>
          </section>
        </Paper>
      ...
      <div className={styles["job-details-bottom-buttons"]}>
        <Button onClick={()=>back()} style={{width: "185px", height: "46px"}} className={`btn-green-outlined`}>
          Back
        </Button>
      </div>
    </section>}
